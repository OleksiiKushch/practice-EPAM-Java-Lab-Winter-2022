...
import static com.epam.task11.controller.ContextListener.PATH_DEFAULT_USER_AVATAR;
...
public class DisplayUserAvatarServlet extends HttpServlet implements DisplayImage {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        displayImage(request, response, ContextListener.ABSOLUTE_PATH_STORAGE_USER_AVATARS, PATH_DEFAULT_USER_AVATAR);
    }
}
